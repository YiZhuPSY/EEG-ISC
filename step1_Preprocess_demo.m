...
% This code supports versions of EEGLAB (version 14.1.0) and MATLAB (R2016b). 

% To run this code appropriately, you need to add the EEGLAB toolbox including its sub-folders to the searching path.
% EEGLAB can be downloaded from https://sccn.ucsd.edu/eeglab/download.php.  
